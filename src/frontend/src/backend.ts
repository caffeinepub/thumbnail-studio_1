...
export class Backend implements backendInterface {
    ...
    async applyCustomizationsToThumbnail(arg0: ExternalBlob, arg1: string): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.applyCustomizationsToThumbnail(await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg0), arg1);
    ...
    async enhanceThumbnail(arg0: ExternalBlob): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.enhanceThumbnail(await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg0));
                return from_candid_ExternalBlob_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateThumbnailFromText(arg0: string): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.generateThumbnailFromText(arg0);
                return from_candid_ExternalBlob_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateThumbnailsFromVideo(arg0: string): Promise<Array<ExternalBlob>> {
        if (this.processError) {
            try {
                const result = await this.actor.generateThumbnailsFromVideo(arg0);
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ExternalBlob>): Promise<Array<ExternalBlob>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ExternalBlob_n9(_uploadFile, _downloadFile, x)));
}
